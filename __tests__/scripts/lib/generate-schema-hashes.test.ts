...
describe('generate-schema-hashes', () => {
  ...
  describe('extractSchemaShape', () => {
    it('should throw error for invalid schema', () => {
      ...
      expect(() => extractSchemaShape({})).toThrow('Schema does not have a shape property');
    });
    ...
    it('should throw when schema has no shape', () => {
      ...
      expect(() => extractSchemaShape(mockSchema)).toThrow('Schema does not have a shape property');
    });
  });
